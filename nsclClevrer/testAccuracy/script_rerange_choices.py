...
parser.add_argument('--raw_ques_path', type=str, default='../question_parsing/data/raw_questions/multiple_choice_questions.json')
...
def rerange_choices(args):
    ...
    pred_dict_list = jsonload(args.filepath)
    ...
    jsondump('test.json', new_list_output)
